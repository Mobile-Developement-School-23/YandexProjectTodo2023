...
final class YandexToDo2022Tests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        toDoItem1 = ToDoItem(id: "testID1", text: "testText1", priority: .low, deadline: Date.now.addingTimeInterval(1600), isDone: false, creationDate: .now, modifyDate: Date.now.addingTimeInterval(4200))
